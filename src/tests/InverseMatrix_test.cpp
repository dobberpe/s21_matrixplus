...
ASSERT_EQ(result.get_rows(), 3);
ASSERT_EQ(result.get_cols(), 3);
ASSERT_NEAR(result[0][0], 0.176471, 1e-7);
ASSERT_NEAR(result[0][1], -0.235294, 1e-7);
ASSERT_NEAR(result[0][2], 0.117647, 1e-7);
ASSERT_NEAR(result[1][0], -0.529412, 1e-7);
ASSERT_NEAR(result[1][1], 0.294118, 1e-7);
ASSERT_NEAR(result[1][2], 0.147059, 1e-7);
ASSERT_NEAR(result[2][0], 0.352941, 1e-7);
ASSERT_NEAR(result[2][1], -0.117647, 1e-7);
ASSERT_NEAR(result[2][2], 0.029412, 1e-7);
}